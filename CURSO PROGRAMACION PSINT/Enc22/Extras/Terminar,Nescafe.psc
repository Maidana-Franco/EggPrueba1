...
SubProceso procesaMatriz(matriz por referencia,filas,columnas)
...
//					matriz(4,j)=matriz(4,j)+matriz(i,j)
	...
	Escribir "El total general de las ventas es:  " matriz(4,5)
	
	Escribir "El mejor vendedor fue: " productoI+1
...
//	Definir totalProducto,productoMasVendido,productoI,totalSemana Como Entero
